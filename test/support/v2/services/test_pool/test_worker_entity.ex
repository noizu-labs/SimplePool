...
defmodule Noizu.SimplePool.Support.TestV2WorkerEntity do
  @vsn 1.0
  ...
  defimpl Noizu.ERP, for: Noizu.SimplePool.Support.TestV2WorkerEntity do
    def id(obj) do
      obj.identifier
    end # end sref/1

    def ref(obj) do
      {:ref, Noizu.SimplePool.Support.TestV2WorkerEntity, obj.identifier}
    end # end ref/1
  ...
  # Inspect Protocol
  #-----------------------------------------------------------------------------
  defimpl Inspect, for: Noizu.SimplePool.Support.TestV2WorkerEntity do
    import Inspect.Algebra
    def inspect(entity, opts) do
      heading = "#TestV2WorkerEntity(#{inspect entity.identifier})"
