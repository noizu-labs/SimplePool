...
defmodule  Noizu.SimplePool.V2.ClusterManagement.Cluster.Service.Instance.StateEntity do
  @vsn 1.0
  @type t :: %__MODULE__{
               identifier: atom, # {node, service}
               status: atom,
               state: atom,
               pending_state: atom,
               service_instance_definition: Noizu.SimplePool.V2.ClusterManagement.Cluster.Service.Instance.Definition.t,
               status_details: Noizu.SimplePool.V2.ClusterManagement.Cluster.Service.Instance.Status.t,
  ...
  defstruct [
    ...
    service_instance_definition: nil,
    status_details: nil,
  ...
  use Noizu.Scaffolding.V2.EntityBehaviour,
      sref_module: "service-instance-state",
      entity_table:  Noizu.SimplePool.V2.Database.Cluster.Service.Instance.StateTable

  defimpl Noizu.ERP, for: Noizu.SimplePool.V2.ClusterManagement.Cluster.Service.Instance.StateEntity do
